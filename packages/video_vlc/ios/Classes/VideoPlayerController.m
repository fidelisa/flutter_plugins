...
- (void)viewDidLoad {
  ...
  UITapGestureRecognizer *gestureRecognizer0 =
      [[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(tapGestureEmpty:)];
...
- (UIView *)navigationBarStackView {
  if (!_navigationBarView) {
    ...
    [NSLayoutConstraint activateConstraints:@[
      [NSLayoutConstraint constraintWithItem:self.doneButton
...
- (void)setupNavigationbar {
  if (self.navigationBarStackView.superview == nil) {
    ...
    [NSLayoutConstraint activateConstraints:@[
      [NSLayoutConstraint constraintWithItem:self.navigationBarStackView
                                   attribute:NSLayoutAttributeCenterY
                                   relatedBy:NSLayoutRelationEqual
