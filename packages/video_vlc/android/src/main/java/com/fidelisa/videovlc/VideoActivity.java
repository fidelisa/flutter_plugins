...
public class VideoActivity extends AppCompatActivity implements IVLCVout.Callback {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mSurface.setLayoutParams(new FrameLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
                ViewGroup.LayoutParams.MATCH_PARENT));
        mMediaPlayer.getVLCVout().setWindowSize(getResources().getDisplayMetrics().widthPixels,
    ...
    private Toolbar handleToolbar(Intent intent) {
        ...
        toolbarOK.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                finish();
            }
